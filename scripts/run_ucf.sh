CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 main.py \
        --arch resnet34 --num_segments 8 --seed 1000 --wandb \
        --gd 20 --lr 1e-3 --lr_steps 20 30 --epochs 50 --training --testing \
        --train_batch-size 8 --test_batch-size 4 --exemplar_batch-size 4 -j 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 main.py \
        --arch resnet34 --num_segments 8 --seed 2021 --wandb \
        --gd 20 --lr 1e-3 --lr_steps 20 30 --epochs 50 --training --testing \
        --train_batch-size 8 --test_batch-size 4 --exemplar_batch-size 4 -j 8 \
