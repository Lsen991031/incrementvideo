CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --nproc_per_node=4 --master_port=29506 main.py \
        --arch resnet50 --num_segments 8 --seed 2021 \
        --gd 20 --lr 2e-4 --lr_steps 20 30 --epochs 1 --training --testing \
        --train_batch-size 2 --test_batch-size 2 --exemplar_batch-size 2 -j 8 \
        --start_task 25 --exp 1002 --exemplar --nme \
