...
parser.add_argument('--exemplar_path', default="/media/data/Lsen/HSNET-DDPTCD-main/checkpoint/ucf101/exemplar")
parser.add_argument('--num_per_class_list', default=51, type=float)
parser.add_argument('--exemplar_iteration', default=2000, type=float)
parser.add_argument('--weight_lr', default=0.1, type=float)
parser.add_argument('--learnable_para_lr', default=0.01, type=float)