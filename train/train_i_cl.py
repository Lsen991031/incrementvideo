    ...
    for i, (input, target, _) in enumerate(train_loader):
        ...
        if age > 0:
            if args.cl_type == 'DIST':
                ...
                loss = lambda_0[0] * loss_ce + args.lambda_1 * loss_att  + args.lambda_1 * loss_att  # + lambda_0[1] * loss_kd_logit
        ...
        losses_att1.update(loss_att1.item(), input.size(0))
        ...
        if args.wandb:
            wandb.log({"task_{}/loss".format(age): losses.avg,
                ...
                "task_{}/loss_kd (att1)".format(age): losses_att1.avg,
                })
...
def train_task(args, age, current_task, current_head, class_indexer, model_old=None, prefix=None, num_per_class=None):
    ...
    a = [5 for i in range(len(num_per_class))]
    print(a)
