...
def manage_exemplar_set(args, age, current_task, current_head, class_indexer, prefix):\
    ...
    print("train_loader_for_exemplar len is :{}".format(len(train_loader_for_exemplar))) # 1199 # 150
    ...
    print("train_loader_for_exemplar len is#############################") # 1199 # 150
    if age > 0:
        # Reduce Exemplar Set
        if args.budget_type == 'fixed':
